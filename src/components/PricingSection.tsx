    ...
    <section id="preco" style={{ position: "relative", overflow: "hidden", padding: "96px 0" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "900px", margin: "0 auto", padding: "0 16px" }}>
        ...
        <motion.div
          ...
          style={{ position: "relative", maxWidth: "760px", margin: "0 auto -168px", transform: "translateY(-50px)" }}
        >
          <img
        ...
        <a
          ...
          style={{
            ...
            margin: "0 auto 16px", transform: "translateY(-90px)",
          ...
          onMouseEnter={e => {
            ...
            (e.currentTarget as HTMLElement).style.transform = "translateY(calc(-90px - 2px)) scale(1.02)";
          }}
          onMouseLeave={e => {
