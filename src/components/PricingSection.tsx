  ...
  return (
    <section id="preco" className="relative overflow-hidden py-24">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/backgrounds/Background_Pricing.webp')" }}
      />
      ...
      <div className="relative z-[1] max-w-[900px] mx-auto px-4">
        ...
        >
          <picture>
            <source srcSet="/images/Ingresso_1.webp" type="image/webp" />
            <img
        ...
        >
          <picture>
            <source srcSet="/images/Ingresso_2.webp" type="image/webp" />
            <img
